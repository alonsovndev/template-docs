...
4. **Ask, capped at 10.** Use as few as the section needs — often 5 or fewer is
   ...
   roles, or ownership gaps to resolve. Ask directly in chat, batching questions
   into a short numbered list.

5. **Write.** Apply clear technical-writing/Markdown practice (use a
   technical-writer/markdown-author chat mode or extension if available). Edit
